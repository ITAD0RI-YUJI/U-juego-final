...
gusano_movimento = [
    ...
    pygame.image.load("../multimedia/img/pets/cien/warm10.png").convert_alpha(),
    pygame.image.load("../multimedia/img/pets/cien/warm11.png").convert_alpha(),
    pygame.image.load("../multimedia/img/pets/cien/warm12.png").convert_alpha(),
    pygame.image.load("../multimedia/img/pets/cien/warm13.png").convert_alpha(),
]